//Scott Lindh 2018
//JS implimentation of the SPERO EXCHANGE API
//
//
/////
...
var accessKey = ""; //Your SPERO EXCHANGE access key.
exports.accessKey = exports.accessKey;
var secretKey = ""; //Your SPERO EXCHANGE secret key.
...
/*
orderBook("sperodoge", function(res){
        if(!res.error){
                console.log(res);
        }else{
                console.log("ERROR: " + res)
...
/*
myTrades("sperodoge", function(res){
        if(!res.error){
                console.log(res);
        }else{
                console.log("ERROR: " + res)
